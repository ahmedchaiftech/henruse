...
for /f "tokens=1,2" %%c in ('echo !cver!') do (
set g1=%%c
...
echo %%f !MD5!>> !ld!\old_gim.md5

GimConv\GimConv!g2! !ld!\img\%%~nf.gim -o !ld!\img\%%~nf.png
rem move !ld!\img\%%~nf.gim !ld!\old\%%~nf.gim
)
)
rem del /Q /S !ld!\img\*.gim
